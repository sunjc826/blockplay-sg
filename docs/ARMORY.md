...
## Prone heavy-weapon mount

Big Encik, the base CIS 50MG, requires grounded prone support for safe firing.
Press **Z** or tap **Prone** to deploy the mount; it locks movement while the

...
Fifteen Singapore districts are playable. Every one is an authored, compressed
...
The twelve districts added afterwards were composed **from general knowledge of

...
Sixteen Singapore districts are playable. Every one is an authored, compressed
...
The thirteen districts added afterwards were composed **from general knowledge of

...
export const WORLD_ZONES: readonly WorldZone[] = [
  ...
  { id: 'tampines', name: 'Tampines', description: 'A wide town centre with the community hub and market as hard cover; the quarry edge has none.', spawn: { x: -20, z: 8, yaw: Math.PI / 2, pitch: 0 },
...
export const WORLD_GATEWAYS: readonly WorldGateway[] = [
  ...
  { id: 'toa-payoh-to-bishan', from: 'toa-payoh', to: 'bishan', name: 'Bishan checkpoint', position: { x: -230, z: 0 }, radius: 4, arrival: { x: -218, z: -74, yaw: -Math.PI / 2, pitch: 0 } },
  { id: 'bishan-to-toa-payoh', from: 'bishan', to: 'toa-payoh', name: 'Toa Payoh checkpoint', position: { x: -230, z: -74 }, radius: 4, arrival: { x: -218, z: 0, yaw: -Math.PI / 2, pitch: 0 } },
  { id: 'upper-thomson-to-bishan', from: 'upper-thomson', to: 'bishan', name: 'Bishan checkpoint', position: { x: -235, z: -128 }, radius: 4, arrival: { x: -60, z: 168, yaw: 0, pitch: 0 } },
  { id: 'bishan-to-upper-thomson', from: 'bishan', to: 'upper-thomson', name: 'Upper Thomson checkpoint', position: { x: -60, z: 180 }, radius: 4, arrival: { x: -223, z: -128, yaw: -Math.PI / 2, pitch: 0 } },

...
const EXPECTED = {
  ...
  'p30-issued': { damage: 28, capacity: 15, interval: 0.22, reload: 1.25, recoil: 0.022, recoilRecovery: 1.35, mobility: 1.14, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 12, far: 42, minScale: 0.35 }, { kind: 'precision', multiplier: 1.8 }] },
  'p30-kopi': { damage: 32, capacity: 15, interval: 0.22, reload: 1.05, recoil: 0.022, recoilRecovery: 1.55, mobility: 1.14, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 12, far: 42, minScale: 0.35 }, { kind: 'precision', multiplier: 1.8 }] },
  'p30-marksman': { damage: 42, capacity: 15, interval: 0.22, reload: 1.25, recoil: 0.016, recoilRecovery: 1.35, mobility: 1.083, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 12, far: 42, minScale: 0.35 }, { kind: 'precision', multiplier: 1.8 }, { kind: 'precision', multiplier: 2.1 }] },
  'mag-issued': { damage: 60, capacity: 100, interval: 0.12, reload: 4.6, recoil: 0.042, recoilRecovery: 0.75, mobility: 0.74, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 45, far: 120, minScale: 0.7 }, { kind: 'precision', multiplier: 1.5 }] },
  'mag-chope': { damage: 66, capacity: 125, interval: 0.112, reload: 5, recoil: 0.037, recoilRecovery: 0.87, mobility: 0.74, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 45, far: 120, minScale: 0.7 }, { kind: 'precision', multiplier: 1.5 }] },
  'mag-jaga': { damage: 70, capacity: 100, interval: 0.108, reload: 4.6, recoil: 0.034, recoilRecovery: 0.95, mobility: 0.7104, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 45, far: 120, minScale: 0.7 }, { kind: 'precision', multiplier: 1.5 }] },
  'cis50-issued': { damage: 160, capacity: 50, interval: 0.14, reload: 5.8, recoil: 0.064, recoilRecovery: 0.65, mobility: 0.55, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 55, far: 140, minScale: 0.75 }, { kind: 'precision', multiplier: 1.4 }] },
  'cis50-tuas': { damage: 168, capacity: 75, interval: 0.12, reload: 6.4, recoil: 0.054, recoilRecovery: 0.75, mobility: 0.5225, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 55, far: 140, minScale: 0.75 }, { kind: 'precision', multiplier: 1.4 }] },
  'cis50-merlion': { damage: 178, capacity: 50, interval: 0.115, reload: 5.8, recoil: 0.052, recoilRecovery: 0.83, mobility: 0.528, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 55, far: 140, minScale: 0.75 }, { kind: 'precision', multiplier: 1.4 }] },
} as const;

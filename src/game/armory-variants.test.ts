...
const EXPECTED = {
  ...
  'mag-issued': { damage: 44, capacity: 100, interval: 0.1, reload: 4.6, recoil: 0.037, recoilRecovery: 0.8, mobility: 0.78, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 40, far: 110, minScale: 0.65 }, { kind: 'precision', multiplier: 1.5 }] },
  'mag-chope': { damage: 50, capacity: 125, interval: 0.1, reload: 5, recoil: 0.032, recoilRecovery: 0.92, mobility: 0.78, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 40, far: 110, minScale: 0.65 }, { kind: 'precision', multiplier: 1.5 }] },
  'mag-jaga': { damage: 54, capacity: 100, interval: 0.088, reload: 4.6, recoil: 0.029, recoilRecovery: 1, mobility: 0.7488, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 40, far: 110, minScale: 0.65 }, { kind: 'precision', multiplier: 1.5 }] },
  'cis50-issued': { damage: 72, capacity: 50, interval: 0.14, reload: 5.8, recoil: 0.064, recoilRecovery: 0.65, mobility: 0.55, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 55, far: 140, minScale: 0.75 }, { kind: 'precision', multiplier: 1.4 }] },
  'cis50-tuas': { damage: 80, capacity: 75, interval: 0.12, reload: 6.4, recoil: 0.054, recoilRecovery: 0.75, mobility: 0.5225, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 55, far: 140, minScale: 0.75 }, { kind: 'precision', multiplier: 1.4 }] },
  'cis50-merlion': { damage: 90, capacity: 50, interval: 0.115, reload: 5.8, recoil: 0.052, recoilRecovery: 0.83, mobility: 0.528, aimFov: HIP_FOV, optic: 'iron', ballistics: HITSCAN, traits: [{ kind: 'falloff', near: 55, far: 140, minScale: 0.75 }, { kind: 'precision', multiplier: 1.4 }] },
} as const;

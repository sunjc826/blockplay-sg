...
import { chooseEncikTone, chooseRankSet, claimReward, claimElimination, consumeItem, createProfile, equip, purchase, purchaseLevel, restoreProfile, STORAGE_KEY, unequipAttachment, type ArmoryProfile, type ExerciseReward } from './armory-state';
...
export function useArmory() {
  ...
  return { profile, buy, buyLevel, wearRankSet, setEncikTone, equipItem, remove, award, awardElimination, consume, demoTopUp, message, saveError };
}

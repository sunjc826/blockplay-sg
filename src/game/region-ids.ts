...
export const REGION_IDS = ['marina-bay', 'raffles-place', 'queenstown', 'chinatown', 'kampong-glam', 'jurong-lake', 'changi', 'upper-thomson', 'punggol', 'harbourfront', 'sentosa', 'geylang', 'tuas', 'woodlands', 'tampines', 'orchard'] as const;
